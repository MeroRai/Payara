...
public interface MonitoringService extends ConfigExtension, PropertyBag {
    ...
    /**
     * Gets the value of the mbean-enabled attribute. This boolean attribute determines whether monitoring mbeans are enabled or disabled. When disabled, all
     * montioring activity will be disabled
     *
    ...
    /**
     * Gets the value of the monitoring-enabled attribute. This boolean attribute determines whether monitoring mebans are enabled or disabled. When disabled,
     * all montioring activity will be disabled
     *
     * @return present monitoring activity status
     */
    @Attribute(defaultValue = "true", dataType = Boolean.class)
        ...
        public static String getMonitoringLevel(MonitoringService ms, String name) {
            ...
            while (itr.hasNext()) {
                ...
                if (rName.equalsIgnoreCase(methodName.substring(3))) {
                    ...
                    } catch (NoSuchMethodException | IllegalAccessException | java.lang.reflect.InvocationTargetException nsme) {
